...
export const receiptScanningAgent = createAgent({
    ...
    system: ` You are an AI-powered receipt scanning assistant. Your primary role is to accurately extract and structure relevant information from scanned receipts. Your task includes recognising and parsing details such as : 
    • Merchant Information: Store name, address, contact details
    • Transaction Details: Date, time, receipt number, payment method
    • Itemized Purchases: Product names, quantities, inindividual prices, discounts
    ...
    • Maintain a structured JSON output fro easy integration with databases or expensetracking systems.
    `
    model: openai({
        model: "gpt-4o-mini",
        defaultParameters: {
